...
function Calendar({
 ...
 className={cn(
"group/calendar p-(--calendar-padding) [--cell-size:var(--calendar-cell-size)] in-data-[slot=card-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent",
...
"flex h-(--cell-size) w-full items-center justify-center gap-(--calendar-dropdown-gap) text-sm font-medium",
 ...
 dropdown_root: cn(
"relative rounded-(--calendar-dropdown-radius) border border-(--calendar-dropdown-border-color) shadow-xs has-focus:border-(--calendar-dropdown-border-color-focus) 
