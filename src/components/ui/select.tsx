...
function SelectTrigger({
    ...
    return (
        <SelectPrimitive.Trigger
            ...
            data-size={size}
            className={cn(
                "flex w-fit items-center justify-between gap-(--select-trigger-gap) rounded-(--select-trigger-radius) border border-(--select-trigger-border-color) bg-(--select-trigger-bg) px-(--select-trigger-padding-x) py-(--select-trigger-padding-y) text-sm whitespace-nowrap shadow-xs transition-[color,box-shadow] outline-none disabled:cursor-not-allowed disabled:opacity-50 aria-invalid:border-(--select-trigger-border-color-invalid) aria-invalid:ring-(--select-trigger-ring-color-invalid) data-placeholder:text-(--select-trigger-placeholder-color) data-[size=default]:h-(--select-trigger-height) data-[size=sm]:h-(--select-trigger-height-sm) *:data-[slot=select-value]:line-clamp-1 *:data-[slot=select-value]:flex *:data-[slot=select-value]:items-center *:data-[slot=select-value]:gap-(--select-trigger-gap) hover:bg-(--select-trigger-bg-hover) [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-(--select-icon-size) [&_svg:not([class*='text-'])]:text-muted-foreground",
                className
            )}
            {...props}
        >
