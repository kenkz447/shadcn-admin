...
function SelectTrigger({
 ...
 data-size={size}
 className={cn(
"flex w-fit items-center justify-between gap-(--select-trigger-gap) rounded-(--select-trigger-radius) border border-(--select-trigger-border-color) bg-(--select-trigger-bg) px-(--select-trigger-padding-x) py-(--select-trigger-padding-y) text-sm whitespace-nowrap shadow-xs transition-[color,box-shadow] outline-none focus-visible:border-(--select-trigger-border-color-focus) disabled:cursor-not-allowed disabled:opacity-50 aria-invalid:border-(--select-trigger-border-color-invalid) aria-invalid:ring-(--select-trigger-ring-color-invalid) data-placeholder:text-(--select-trigger-placeholder-color) data-[size=default]:h-(--select-trigger-height) data-[size=sm]:h-(--select-trigger-height-sm) *:data-[slot=select-value]:line-clamp-1 *:data-[slot=select-value]:flex *:data-[slot=select-value]:items-center *:data-[slot=select-value]:gap-(--select-trigger-gap) hover:bg-(--select-trigger-bg-hover) [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-(--select-icon-size) [&_svg:not([class*='text-'])]:text-muted-foreground",
 className
 )}
 {...props}
 >
...
function SelectItem({
 ...
 className={cn(
"relative flex w-full cursor-default items-center gap-(--select-item-gap) rounded-(--select-item-radius) py-(--select-item-padding-y) pr-(--select-item-padding-right) pl-(--select-item-padding-left) text-sm outline-hidden select-none focus:bg-accent focus:text-accent-foreground data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-(--select-icon-size) [&_svg:not([class*='text-'])]:text-muted-foreground *:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-(--select-item-gap)",
 className
 )}
 {...props}
 >
