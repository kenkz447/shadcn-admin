  ...
  return (
    <input
      ...
      className={cn(
        ...
        "focus-visible:border-(--input-focus-border-color) focus-visible:ring-(length:--input-focus-ring-width) focus-visible:ring-(--input-focus-ring-color)",
        "aria-invalid:border-(--input-invalid-border-color) aria-invalid:ring-(--input-invalid-ring-color)",
        className
      )}
      {...props}
    />
